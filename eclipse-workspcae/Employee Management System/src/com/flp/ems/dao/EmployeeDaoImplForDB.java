...
public class EmployeeDaoImplForDB implements IEmployeeDao{
	...
	public boolean ModifyEmployee(Employee employee) {
		...
		try {
			dbConnection = DriverManager.getConnection(url);
			try(PreparedStatement updatestmt=dbConnection.prepareStatement(props.getProperty("jdbc.query.search.on.kinid"), ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE))
			{
