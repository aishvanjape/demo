 ...
 * 2016-10-18T16:45:34.485+05:30
 * Generated source version: 2.7.8
 * 
 */
@WebServiceClient(name = "Orders", 
                  wsdlLocation = "http://localhost:8080/apache-cxf-jax-ws-demo/services/orders?wsdl",
...
public class Orders_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/apache-cxf-jax-ws-demo/services/orders?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Orders_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/apache-cxf-jax-ws-demo/services/orders?wsdl");
        }
        WSDL_LOCATION = url;
    }
